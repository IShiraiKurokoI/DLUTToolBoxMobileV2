...
public class ScanQRCodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(view -> PictureSelector.create(ScanQRCodeActivity.this)
                        ...
                        for (LocalMedia media : result) {
                            if (media.getWidth() == 0 || media.getHeight() == 0) {
                                if (PictureMimeType.isHasImage(media.getMimeType())) {
                                    MediaExtraInfo imageExtraInfo = MediaUtils.getImageSize(ScanQRCodeActivity.this, media.getPath());
                            ...
                            if (resultTxt == null) {
                                Toast.makeText(ScanQRCodeActivity.this, "未检测到二维码", Toast.LENGTH_SHORT).show();
                                return;
                            }
    ...
    private void initView() {
        ...
        mScanSurfaceView.setOnScanCallback(new OnScanCallback() {
            ...
            public void onFail(String msg) {
                Toast.makeText(ScanQRCodeActivity.this, msg + "扫码失败", Toast.LENGTH_SHORT).show();
