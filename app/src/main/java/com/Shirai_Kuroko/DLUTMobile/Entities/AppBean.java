...
public class AppBean implements Serializable
{
    ...
    public static AppBean getAppCenterInfo(final Context context) {
        final AppBean appCenter = AppBean.appCenter;
        appCenter.setApp_id("-1");
        appCenter.setApp_name("");
        final Bitmap decodeResource = BitmapFactory.decodeResource(context.getResources(), AppBean.iconRes);
        return appCenter;
    }
    ...
    public void setCustom_info(final AppCustomInfoBean custom_info) {
    ...
    public void setDeveloper(final AppDeveloperBean developer) {
    ...
    public void setNativeStatus(final String nativeStatus) {
    ...
    public void setScore(final AppScoreBean score) {
        this.score = score;
    }
