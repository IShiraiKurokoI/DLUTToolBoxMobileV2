...
public class CacheManager {
    ...
    public static void clearAllCache(Context context) {
        ...
        deleteDir(context.getExternalFilesDir("Logs"));
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
