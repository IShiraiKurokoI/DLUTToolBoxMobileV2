...
public class WIFIStateChangeBroadcastReceiver extends BroadcastReceiver {
    ...
    public void DoNotification(Context context, String title, String content) {
        ...
        if (manager != null) {
            ...
            builder.addAction(R.drawable.icon,"手动连接", PendingIntent.getBroadcast(context, 0, new Intent("com.Shirai_Kuroko.DLUTMobile.ManualConnect"), 0));
            builder.addAction(R.drawable.icon,"断开连接", PendingIntent.getBroadcast(context, 0, new Intent("com.Shirai_Kuroko.DLUTMobile.ManualDisconnect"), 0));
            builder.addAction(R.drawable.icon,"打开自服务", PendingIntent.getBroadcast(context, 0, new Intent("com.Shirai_Kuroko.DLUTMobile.OpenService"), 0));
